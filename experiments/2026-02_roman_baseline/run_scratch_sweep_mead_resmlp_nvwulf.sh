...
set -e
echo "========================================"
echo "SCRATCH DATA SIZE SWEEP - Roman CS LCDM Mead (ResMLP) T200"
echo "Started: $(date)"
echo "Host: $(hostname)"
echo "========================================"
...
BASE_YAML="${COCOA}/projects/roman_real/roman_emulator_cs_mead_nvwulf.yaml"

OUTPUT_BASE="${COCOA}/projects/roman_real/chains/mead_scratch"
...
for idx in "${!SIZES[@]}"; do
    ...
    MODEL_NAME="roman_cs_lcdm_mead_resmlp_T200_N${size}"
    TEMP_YAML="${YAML_DIR}/roman_emulator_cs_mead_resmlp_T200_N${size}.yaml"
