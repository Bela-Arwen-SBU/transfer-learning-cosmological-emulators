#!/bin/bash
# =============================================================================
# TL N_train sweep: LCDM -> w0wa, Takahashi, T500 run1
...
echo "========================================"
echo "TL N_train SWEEP - LCDM->w0wa Taka freeze=${FREEZE_STRATEGY} LR=1e-3 BS=32"
echo "Started: $(date)"
echo "Host:    $(hostname)"
echo "========================================"
...
OUTPUT_BASE="${COCOA}/projects/roman_real/chains/taka_lcdm2w0wa_tl_T500_run1_clip90_intdim362"
