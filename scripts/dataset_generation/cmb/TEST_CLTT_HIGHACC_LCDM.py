...
Usage:
    python TEST_CLTT_HIGHACC_LCDM.py              # Both lightweight + CAMB (default)
    python TEST_CLTT_HIGHACC_LCDM.py --quick      # Lightweight only
    python TEST_CLTT_HIGHACC_LCDM.py --camb-only  # CAMB validation only
    python TEST_CLTT_HIGHACC_LCDM.py --n-samples 20 --seed 456
"""
import numpy as np
import sys
import argparse
