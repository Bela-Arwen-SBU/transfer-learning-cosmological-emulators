...
set -e
echo "========================================"
echo "TL STRATEGY SWEEP - Taka T200 -> Mead T200 (ResMLP)"
echo "Started: $(date)"
echo "Host: $(hostname)"
echo "========================================"
...
BASE_YAML="/lustre/nvwulf/projects/MirandaGroup-nvwulf/bela/cocoa/Cocoa/projects/roman_real/roman_emulator_cs_mead_nvwulf.yaml"
PRETRAINED_MODEL="/lustre/nvwulf/projects/MirandaGroup-nvwulf/bela/cocoa/Cocoa/projects/roman_real/chains/taka_scratch/models/roman_cs_lcdm_taka_resmlp_T200_N500000.pt"
TRAIN_EMULATOR="/lustre/nvwulf/projects/MirandaGroup-nvwulf/bela/cocoa/Cocoa/train_emulator.py"

OUTPUT_BASE="/lustre/nvwulf/projects/MirandaGroup-nvwulf/bela/cocoa/Cocoa/projects/roman_real/chains/mead_tl_from_taka_T200"
...
echo "Probe:             ${PROBE}"
echo "Source model:      Taka T200 N=500k"
echo "Target:            Mead T200"
...
for idx in "${!STRATEGIES[@]}"; do
    ...
    MODEL_NAME="roman_cs_lcdm_mead_resmlp_tl_fromTaka_T200_N${N_TRAIN}_fs_${strategy}"
    TEMP_YAML="${YAML_DIR}/mead_tl_fromTaka_T200_N${N_TRAIN}_fs_${strategy}.yaml"
...
# Data - mead T200 (already correct in base yaml, just set n_train)
