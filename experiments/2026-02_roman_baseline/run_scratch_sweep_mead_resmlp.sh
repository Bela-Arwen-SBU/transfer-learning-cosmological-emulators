...
set -e
echo "========================================"
echo "SCRATCH DATA SIZE SWEEP - Roman CS LCDM Mead (ResMLP)"
echo "Started: $(date)"
echo "Host: $(hostname)"
echo "========================================"
...
OUTPUT_BASE="/home/grads/tmp/roman_cs_baseline/output_mead_resmlp"
...
for idx in "${!SIZES[@]}"; do
    ...
    MODEL_NAME="roman_cs_lcdm_mead_resmlp_N${size}"
    TEMP_YAML="${YAML_DIR}/roman_emulator_cs_mead_resmlp_N${size}.yaml"
