...
set -e
echo "========================================"
echo "SCRATCH DATA SIZE SWEEP - Roman CS LCDM Taka (ResCNN, batch=32)"
echo "Started: $(date)"
echo "Host: $(hostname)"
echo "========================================"
PROBE="cosmic_shear"
...
OUTPUT_BASE="/home/grads/tmp/roman_cs_baseline/output_taka_cnn_b32"
...
for idx in "${!SIZES[@]}"; do
    ...
    echo "========================================================================"
    echo "Started: $(date)"
    MODEL_NAME="roman_cs_lcdm_taka_cnn_b32_N${size}"
    TEMP_YAML="${YAML_DIR}/roman_emulator_cs_taka_cnn_b32_N${size}.yaml"
