...
OUTPUT_BASE="/home/grads/tmp/roman_cs_baseline/outputs/output_taka_resmlp_T200"
...
config['train_args']['train_datavectors_file'] = 'roman_real_lcdm_b_taka_train_datavectors_T200.npy'
config['train_args']['train_parameters_file']  = 'roman_real_lcdm_b_taka_train_parameters_T200.txt'

config['train_args']['n_valid'] = 10000
config['train_args']['t_valid'] = 100
config['train_args']['valid_datavectors_file'] = 'roman_real_lcdm_b_taka_valid_datavectors_T100.npy'
config['train_args']['valid_parameters_file']  = 'roman_real_lcdm_b_taka_valid_parameters_T100.txt'

config['train_args']['n_test'] = 10000
config['train_args']['t_test'] = 100
config['train_args']['test_datavectors_file']  = 'roman_real_lcdm_b_taka_test_datavectors_T100.npy'
config['train_args']['test_parameters_file']   = 'roman_real_lcdm_b_taka_test_parameters_T100.txt'
