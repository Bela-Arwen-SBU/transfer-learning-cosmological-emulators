...
EPOCHS=250
BATCH_SIZE=256
BASE_YAML="/home/grads/tmp/roman_cs_baseline/roman_emulator_cs.yaml"

# Output directory structure
OUTPUT_BASE="/home/grads/tmp/roman_cs_baseline/output"
...
EOF
    ...
    if [ $TRAIN_EXIT_CODE -eq 0 ]; then
        ...
        if [ -f "losses.txt" ]; then
            mv losses.txt "${LOSSES_DIR}/losses_N${size}.txt"
            echo "  ✓ Saved losses: ${LOSSES_DIR}/losses_N${size}.txt"
        else
