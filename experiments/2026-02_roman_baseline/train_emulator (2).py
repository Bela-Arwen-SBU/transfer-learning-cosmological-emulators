...
parser.add_argument("--transfer_learning", "-st")
...
def train_emulator(train_yaml, probe,
            ...
            save_losses=False, save_testing=False):
    '''
    ...
    with torch.no_grad():
        ...
        # wrapped Yijie's debugging when not saving testing metrics 
        if not save_testing:
...
if __name__ == "__main__":
    train_emulator(cobaya_yaml, probe, 
        ...
        save_losses, save_testing_metrics)
